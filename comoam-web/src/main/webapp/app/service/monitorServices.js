...
angular.module('monitor').factory('monitorService', function($log, $location, $resource, $state) {
	var stepsDict= {
			"KVM" : {
				...
				"upgrade_fullbackup": ["Start", "Health Check","GR Check","Full Backup", "Prepare Upgrade", "Start Upgrade","Post Image Replacement", "Data Restore", "Finished"],
				 ...
				 "chhostname":["Start","Changing Hostname","Finished"],
	              ...
	              "removeipv6": ["Start", "Stop COM", "Removing Ipv6", "Start COM", "Finished"]
			},
			"Openstack" :{
	...
	var endMsg = {
			...
			"removeipv6":{
				"succeed" : "Remove Ipv6 Succeed",
				"failed": "Remove Ipv6 Failed"		
			}
	};
